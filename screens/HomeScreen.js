import { StyleSheet, View, Image, Text, SafeAreaView, Platform, ScrollView, Pressable, TextInput } from 'react-native'
...
const HomeScreen = () => {
  ...
  //to access the cart have use scletorhook
  const cart = useSelector((state) => state.cart.cart);
  // console.log('array',cart)

  //to ceck modal is selected or not
...
//  console.log(selectedAddress)
  ...
  const fetchAddresses = async () => {
    try {
      const response = await axios.get(`${SERVER_URL}/addresses/${userId}`)
      ...
      <SafeAreaView style={{
        ...
        <ScrollView>
          ...
          <Pressable
            ...
            style={{
              flexDirection: 'row', alignItems: 'center', gap: 5, padding: 10, backgroundColor: "#AFEEEE"
            }}
          >
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            {
              offers.map((item, index) => (
                <Pressable onPress={() => navigation.navigate('Info', {
                  ...
                  key={index} style={{ marginVertical: 10, alignItems: 'center' }}>
                  ...
                  <View style={{
                    ...
                    <Text style={{ textAlign: 'center', color: 'white', fontSize: 14, fontWeight: 'bold' }}>Upto {item?.offer} off</Text>
                  </View>
      ...
      >
        <ModalContent style={{ width: '100%', height: 400 }}>
          <View>
            ...
            <Text style={{ marginTop: 5, fontSize: 16, color: 'gray' }}>Select a delivery location to see product availablity and delivery options</Text>
          </View>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
              ...
              <Pressable onPress={()=>setSelectedAddress(item)}
               style={{width:140, height:140,
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 3 }}>
                  <Text  numberOfLines={1} style={{ fontSize: 13, fontWeight: 'bold' }}>
                    {item?.name}
                ...
                <Text numberOfLines={1} style={{width:130,fontSize:13,textAlign:'center'}}>India</Text>
              </Pressable>
            ...
            <Pressable
              ...
              style={{
                ...
                borderColor: '#D0D0D0', marginTop:15, borderWidth: 1, padding: 10, justifyContent: 'center',
                alignItems: 'center'
              }}>
          ...
          <View style={{ flexDirection: 'column', gap: 7, marginBottom: 30 }}>
            <View style={{ flexDirection: 'row', gap: 5, alignItems: 'center' }}>
              <Entypo name="location-pin" size={22} color="#0055b2" />
              <Text style={{ color: '#0055b2', fontWeight: '500' }}>Enter an Indian pincode</Text>
            </View>

            <View style={{ flexDirection: 'row', gap: 5, alignItems: 'center' }}>
              <Ionicons name="locate" size={22} color="#0055b2" />
              <Text style={{ color: '#0055b2', fontWeight: '500' }}>Use my Current location</Text>
            </View>

            <View style={{ flexDirection: 'row', gap: 5, alignItems: 'center' }}>
              <AntDesign name="earth" size={22} color="#0055b2" />
              <Text style={{ color: '#0055b2', fontWeight: '500' }}>Deliver outside India</Text>
            </View>

            {/* <View style={{flexDirection:'row',gap:5,alignItems:'center'}}>
            <Entypo name="location-pin" size={24} color="#0055b2" />
            <Text style={{color:'#0055b2',fontWeight:'500'}}>Enter an Indian pincode</Text>
            </View> */}
          </View>
        </ModalContent>
